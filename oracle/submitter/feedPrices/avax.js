...
async function getPriceData(state, beaconRewardRate) {
  try {
    ...
    const vaavaxPrice = state.avalanche.vesper.vaAVAX.vaAVAXPrice;
    const usdcnPrice = state.avalanche.vesper.USDCn.USDCnPrice;
    const yyGlpPrice = state.avalanche.gmx.glp.yyGlpPrice;
